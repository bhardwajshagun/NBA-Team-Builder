 ...
 * retrieving any of the stats as a float data type. This class is under the Stat interface and is
 * extended to the season and playoff subclasses.
 */
public abstract class standardStats implements Stat {
   ...
   */
  public standardStats(int games, int minutes, int points, int FGM, int FGA, float FG_PER,
                       int THREE_PM, int THREE_PA, float THREE_P_PER, int FTM, int FTA,
                       float FT_PER, int OREB, int DREB, int REB, int AST, int TOV, int STL,
                       int BLK, int PF, int FP, int DD2, int TD3) {
    this.games = games;
